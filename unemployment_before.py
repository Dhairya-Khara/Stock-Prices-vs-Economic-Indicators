"""
CSC110 Final Project: UnemploymentBefore Graph class

Module Description
==================
This module contains the code for the UnemploymentBefore Graph. It inherits from the abstract class Graph.
