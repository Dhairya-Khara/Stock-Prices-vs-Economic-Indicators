"""
CSC110 Final Project: JobOpeningsBefore Graph class

Module Description
==================
This module contains the code for the JobOpeningsBefore Graph. It inherits from the abstract class Graph.
...
class JobOpeningsBefore(Graph):
    ...
    def get_stock_data(self) -> DataFrame:
        ...
        query_string = f'https://query1.finance.yahoo.com/v7/finance/download/{self._ticker}?' \
